module.exports = async srv => {
  ...
  messaging.on(["refappscf/ecc/123/BO/BusinessPartner/Created", "refappscf/ecc/123/ce/sap/s4/beh/businesspartner/v1/BusinessPartner/Created/v1"], async msg => {
    console.log("<< msg caught", msg);
    ...
    } else if (msg.headers && msg.headers.specversion == "1.0") {
      //> Central mock server
  ...
  messaging.on(["refappscf/ecc/123/BO/BusinessPartner/Changed","refappscf/ecc/123/ce/sap/s4/beh/businesspartner/v1/BusinessPartner/Changed/v1"], async msg => {
    let BUSINESSPARTNER = "";
